...
- **Pendiente según el plan MM** (no son fallos): objetos equipables, entre ellos el Lazo Amigo (resto del H2); sprites estáticos de PokeAPI (H3); sin historia (H4).
